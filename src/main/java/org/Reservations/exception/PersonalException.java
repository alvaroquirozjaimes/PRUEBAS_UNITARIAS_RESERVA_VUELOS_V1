package org.Reservations.exception; // Paquete donde se encuentra la clase PersonalException

import org.Reservations.enums.APIError; // Importa la enumeración APIError para manejar errores de la API
