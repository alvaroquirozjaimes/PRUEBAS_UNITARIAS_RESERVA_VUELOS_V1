package org.Reservations.exception; // Paquete donde se encuentra la clase APIExceptionHandler

import org.Reservations.dto.ErrorDTO; // Importa la clase ErrorDTO para manejar errores
import org.Reservations.enums.APIError; // Importa la enumeración APIError para codificar errores de la API
