package org.Reservations.dto;

import jakarta.validation.constraints.NotBlank; // Importa la anotación para validar que los campos no estén en blanco
import org.Reservations.validator.CityFormatConstraint; // Importa la anotación personalizada para validar el formato de las ciudades
