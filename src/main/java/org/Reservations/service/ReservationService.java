package org.Reservations.service; // Especifica el paquete al que pertenece la clase.

import org.Reservations.connector.CatalogConnector; // Importa el conector para acceder al catálogo.
import org.Reservations.connector.response.CityDTO; // Importa el DTO para representar ciudades.
import org.Reservations.dto.ReservationDTO; // Importa el DTO para representar reservas.
import org.Reservations.dto.SegmentDTO; // Importa el DTO para representar segmentos de viaje.
import org.Reservations.enums.APIError; // Importa los códigos de error para la API.
import org.Reservations.exception.PersonalException; // Importa la clase de excepción personalizada.
import org.Reservations.model.Reservation; // Importa el modelo de reserva.
import org.Reservations.repository.ReservationRepository; // Importa el repositorio de reservas.
